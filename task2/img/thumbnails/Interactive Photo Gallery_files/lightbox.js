...
//Hide the overlay when the user clicks on the close button
...
/*
  //Problem: the lightbox needs to support Youtube videos
  //Solution: The img in the li is a thumbnail. The href of the anchor is the href for the iframe. Add the iframe to the overlay and hide it. If the li containing the anchor that is clicked has the class "video", show the iframe and fill it with the video. Else show the image.*/

  //Figure out how to get it to close the overlay so you can test how it's working underneath
