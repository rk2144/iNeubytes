...
<body>
    ...
    <div id="cart">
        <div id="main1">
            <div>
                <h4>Bank Offer</h4>
                <p>10% Instant Discount with Standard Chartered Credit & Debit cards on a min spend of Rs 3,000. TCA</p>
        ...
        <!--- inserted new box n removed the div id'd "main2"---->
    ...
    var amount = localStorage.getItem("amount");
      ...
      var discount= localStorage.getItem("discount")
        ...
        document.querySelector("#first").addEventListener("click",function(){
            window.location.href ="../wishlist/cart.php"
        })

        document.querySelector("#second").addEventListener("click",function(){
            window.location.href ="../payment/address.php"
        })
</script>