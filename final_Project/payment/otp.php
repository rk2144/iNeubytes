    ...
    <body>
        <div id="otpDiv">
            <img src="https://constant.myntassets.com/pwa/assets/img/3a438cb4-c9bf-4316-b60c-c63e40a1a96d1548071106233-mobile-verification.jpg"
                alt="">
            <div id="otpline">
                <h2>Verify with OTP</h2>
                <p>Sent to registered Mobile No.<p id="otpNum"></p></p>
            </div>
            <div id="inputDiv">
           ...
           <button id="checkotp"> <a href="end.php">CONFIRM</a></button></a>
            <div id="checkDiv">
                <h4>RESEND OTP</h4>
            </div>
        </div>
